    ...
    <?php include "../../app/include/sidebar-admin.php"; ?>
        ...
        <div class="posts col-9">
            <div class="button row">
                <a href="<?php echo "http://localhost/OnlineStore/" . "admin/topics/create.php";?>" class="col-2 btn btn-success">Создать</a>
                <span class="col-1"></span>
                <a href="<?php echo "http://localhost/OnlineStore/" . "admin/topics/index.php";?>" class="col-3 btn btn-warning">Редактировать</a>
            </div>
