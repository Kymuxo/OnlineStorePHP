        ...
        <div class="row add-post">
            ...
            <form action="edit.php" method="post">
                ...
                <div class="col">
                        ...
                        <input name="adres" value="<?=$adres;?>" type="text" class="form-control" id="exampleInputAdres" placeholder="введите ваш адрес...">
                        <div id="adresHelp" class="form-text">На введенный адрес будут поступать заказы!</div>
                    </div>
                <input name="userroot" class="form-check-input" value="1" type="checkbox" id="flexCheckChecked">
